...
<!-- MJ: Made the Darwin quote shorter -->
...
<!-- MJ: added "multifunctional" to abstract. Does that help define what we mean by "abstract"? Actually this might not be what the authors meant but that is my beset guess -->
...
<!--MJ: Can we have two more examples?-->
...
```{r existence, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=3, set.cap.width=T, num.cols.cap=1, fig.cap='Cumulative ratios for the production of non-existence at the sentence level for children between 12 to 72 months of age, and their parents.'}
...
<!-- MJ: Probably better to exclude imperatives starting with "does" or "did" because it would be hard to know if they were actually imperatives or just declaratives with no subject, mistakenly tagged as imperative -->
...
<!--MJ: Can we have two more examples in this table-->
...
```{r prohibition, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=3, set.cap.width=T, num.cols.cap=1, fig.cap='Cumulative ratios for the production of prohibition at the sentence level for children between 12 to 72 months of age, and their parents.'}
...
<!--MJ: can we have like 3 more examples in the table below?-->
...
<!--
MJ: reminder that this table has third person subject examples
MJ: Also can we have two more exmaples for this table?
-->
...
```{r inability, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=3, set.cap.width=T, num.cols.cap=1, fig.cap="Cumulative ratios for the production of inability at the sentence level for children between 12 to 72 months of age, and their parents."}
...
```{r learning, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=3, set.cap.width=T, num.cols.cap=1, fig.cap="Cumulative ratios for the production of (negative) labeling at the sentence level for children between 12 to 72 months of age, and their parents."}
...
```{r epistemic, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=7, set.cap.width=T, num.cols.cap=1, fig.cap="Cumulative ratios for the production of epistemic negation at the sentence level for children between 12 to 72 months of age, and their parents."}
...
```{r possession, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=5, set.cap.width=T, num.cols.cap=1, fig.cap="Cumulative ratios for the production of possession at the sentence level for children between 12 to 72 months of age, and their parents."}
...
<!--Analysis 
We assume that children's production of negative constructions can be modeled using a logistic growth function:
Children start with almost no productions for each construction, increase their production at a rate which decreases as production approaches its maximum capacity given parent-child interactions. 

We assume that productions are bound between 0 and some maximum relative frequency K. 
