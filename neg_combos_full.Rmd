...
pos_emotion <-read.csv('data/pos_emotion.txt', header = T, sep = '\t')
# emotion <- subset(emotion, Subj == 'I' | Subj == 'NONE')
...
pos_perception <-read.csv('data/pos_perception.txt', header = T, sep = '\t')
...
pos_motor <-read.csv('data/pos_motor.txt', header = T, sep = '\t')
...
pos_learning <-read.csv('data/pos_learning.txt', header = T, sep = '\t')
...
pos_epistemic <-read.csv('data/pos_epistemic.txt', header = T, sep = '\t')
