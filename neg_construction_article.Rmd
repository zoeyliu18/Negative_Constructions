...
for (i in 1:length(children)){
  select <- data.frame(subset(emotion, Child == children[i] & Polarity == 'negative' & Role == 'Child' & grepl(' nan', children[i]) == FALSE))
    if (min(as.vector(unique(select$Age))) < 24 & as.numeric(length(unique(select$Age))) >= 5){
...
for (i in 1:length(children)){
  select <- data.frame(subset(perception, Child == children[i] & Polarity == 'negative' & Role == 'Child' & Polarity == 'negative' & Function == 'possession' & grepl(' nan', children[i]) == FALSE))
    if (min(as.vector(unique(select$Age))) < 24 & as.numeric(length(unique(select$Age))) >= 5){#} & nrow(select) >= 50){
...
for (i in 1:length(children)){
  select <- data.frame(subset(perception, Child == children[i] & Polarity == 'negative' & Role == 'Child' & Polarity == 'negative' & Function == 'existence' & grepl(' nan', children[i]) == FALSE))
    if (min(as.vector(unique(select$Age))) < 30 & as.numeric(length(unique(select$Age))) >= 5){#} & nrow(select) >= 50){
...
possession_have_children = ''

children <- as.vector(unique(subset(perception, Age<=36)$Child))

for (i in 1:length(children)){
  select <- data.frame(subset(perception, Child == children[i] & Polarity == 'negative' & Role == 'Child' & Polarity == 'negative' & Function == 'possession' & Head %in% c('have') & grepl(' nan', children[i]) == FALSE))
    if (min(as.vector(unique(select$Age))) < 24 & as.numeric(length(unique(select$Age))) >= 5){#} & nrow(select) >= 50){
  possession_have_children = c(children[i], possession_have_children)
  }
}

possession_have_children = possession_have_children[1: length(possession_have_children) - 1]

possession_pro_children = ''
...
for (i in 1:length(children)){
  select <- data.frame(subset(perception, Child == children[i] & Polarity == 'negative' & Role == 'Child' & Polarity == 'negative' & Function == 'possession' & !(Head %in% c('have') & grepl(' nan', children[i]) == FALSE)))
    if (min(as.vector(unique(select$Age))) < 24 & as.numeric(length(unique(select$Age))) >= 5){#} & nrow(select) >= 50){
  possession_pro_children = c(children[i], possession_pro_children)
  }
}

possession_pro_children = possession_pro_children[1: length(possession_pro_children) - 1]


individual_existence_data = 0
individual_possession_have_data = 0
individual_possession_pro_data = 0
...
for (i in possession_have_children){
...
child_individual_possession_have_neg <- negative_moving(child_individual_possession_have_neg, subset(child_individual_descriptive, Child == i))
child_individual_possession_have_neg$Child <- rep(i, nrow(child_individual_possession_have_neg))
individual_possession_have_data <- rbind(child_individual_possession_have_neg, individual_possession_have_data)
...
parent_individual_possession_have_neg <- negative_moving(parent_individual_possession_have_neg, subset(parent_individual_descriptive, Child == i))
parent_individual_possession_have_neg$Child <- rep(i, nrow(parent_individual_possession_have_neg))
individual_possession_have_data <- rbind(parent_individual_possession_have_neg, individual_possession_have_data)
...
child_individual_possession_have_pos <- positive_moving(child_individual_possession_have_pos, subset(child_individual_descriptive, Child == i))
child_individual_possession_have_pos$Child <- rep(i, nrow(child_individual_possession_have_pos))
individual_possession_have_data <- rbind(child_individual_possession_have_pos, individual_possession_have_data)
...
parent_individual_possession_have_pos <- positive_moving(parent_individual_possession_have_pos, subset(parent_individual_descriptive, Child ==i))
parent_individual_possession_have_pos$Child <- rep(i, nrow(parent_individual_possession_have_pos))
individual_possession_have_data <- rbind(parent_individual_possession_have_pos, individual_possession_have_data)

}}


for (i in possession_pro_children){
...
child_individual_possession_pro_neg <- negative_moving(child_individual_possession_pro_neg, subset(child_individual_descriptive, Child == i))
child_individual_possession_pro_neg$Child <- rep(i, nrow(child_individual_possession_pro_neg))
individual_possession_pro_data <- rbind(child_individual_possession_pro_neg, individual_possession_pro_data)
...
parent_individual_possession_pro_neg <- negative_moving(parent_individual_possession_pro_neg, subset(parent_individual_descriptive, Child == i))
parent_individual_possession_pro_neg$Child <- rep(i, nrow(parent_individual_possession_pro_neg))
individual_possession_pro_data <- rbind(parent_individual_possession_pro_neg, individual_possession_pro_data)
...
child_individual_possession_pro_pos <- positive_moving(child_individual_possession_pro_pos, subset(child_individual_descriptive, Child == i))
child_individual_possession_pro_pos$Child <- rep(i, nrow(child_individual_possession_pro_pos))
individual_possession_pro_data <- rbind(child_individual_possession_pro_pos, individual_possession_pro_data)
...
parent_individual_possession_pro_pos <- positive_moving(parent_individual_possession_pro_pos, subset(parent_individual_descriptive, Child == i))
parent_individual_possession_pro_pos$Child <- rep(i, nrow(parent_individual_possession_pro_pos))
individual_possession_pro_data <- rbind(parent_individual_possession_pro_pos, individual_possession_pro_data)
...
individual_possession_have_data$Measure <- factor(individual_possession_have_data$Measure, levels = c('negative construction ratio', 'negative construction moving ratio', 'positive construction ratio', 'positive construction moving ratio'))

individual_possession_have_data <- subset(individual_possession_have_data, Measure %in% c('negative construction moving ratio', 'positive construction moving ratio') & Child != '0')

individual_possession_pro_data$Measure <- factor(individual_possession_pro_data$Measure, levels = c('negative construction ratio', 'negative construction moving ratio', 'positive construction ratio', 'positive construction moving ratio'))

individual_possession_pro_data <- subset(individual_possession_pro_data, Measure %in% c('negative construction moving ratio', 'positive construction moving ratio') & Child != '0')
...
individual_possession_have_data_child <- subset(individual_possession_have_data, Role == 'Child')
individual_possession_have_data_parent <- subset(individual_possession_have_data, Role == 'Parent')

individual_possession_pro_data_child <- subset(individual_possession_pro_data, Role == 'Child')
individual_possession_pro_data_parent <- subset(individual_possession_pro_data, Role == 'Parent')
...
```{r individualexistence, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=5, set.cap.width=T, num.cols.cap=1, fig.cap='Individual variation for Non-existence and its positive counterparts', warning=FALSE}
...
for (i in 1:length(children)){
  select <- data.frame(subset(motor, Child == children[i] & Polarity == 'negative' & Role == 'Child' & Function %in% c('prohibition') & grepl(' nan', children[i]) == FALSE))
    if (min(as.vector(unique(select$Age))) < 30 & as.numeric(as.numeric(length(unique(select$Age))) >= 5)){
      print(children[i])
      print(as.numeric(length(unique(select$Age))))
...
```{r individualprohibition, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=9, set.cap.width=T, num.cols.cap=1, fig.cap='Individual variation for Prohibition and its positive counterparts', warning=FALSE}
...
for (i in 1:length(children)){
  select <- data.frame(subset(epistemic, Child == children[i] & Polarity == 'negative' & Role == 'Child' & Head %in% c('remember') & grepl(' nan', children[i]) == FALSE))
    if (min(as.vector(unique(select$Age))) < 24){#} & as.numeric(length(unique(select$Age))) >= 2){
...
```{r individualpossessionhave, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=9, set.cap.width=T, num.cols.cap=1, fig.cap='Individual variation for Possession and its positive counterparts, when the head verb is have', warning=FALSE}


individual_possession_have_data %>% 
  ggplot(aes(as.numeric(as.character(Age)), round(log(Total_ratio), 2), group = Measure, color = Measure)) +
  geom_line(aes(linetype=Measure), alpha = 1) +
  scale_linetype_manual(values=c('solid','solid')) +
  geom_point(aes(color = Measure, shape = Measure), size = 1) +
...
```{r individualpossessionpro, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=9, set.cap.width=T, num.cols.cap=1, fig.cap='Individual variation for Possession and its positive counterparts, when the syntactic head is a pronoun', warning=FALSE}


individual_possession_pro_data %>% 
  ggplot(aes(as.numeric(as.character(Age)), round(log(Total_ratio), 2), group = Measure, color = Measure)) +
  geom_line(aes(linetype=Measure), alpha = 1) +
  scale_linetype_manual(values=c('solid','solid')) +
  geom_point(aes(color = Measure, shape = Measure), size = 1) +
...
for (i in 1:length(children)){
  select <- data.frame(subset(emotion, Child == children[i] & Polarity == 'negative' & Role == 'Child'))
    if (min(as.vector(unique(select$Age))) < 24 & nrow(select) >= 50){
  emotion_children = c(children[i], emotion_children)
  }
}
