...
children <- c('MPI-EVA-Manchester Fraser', 'MPI-EVA-Manchester Eleanor', 'Braunwald Laura', 'Wells Gary', 'Providence Naima')
...
```{r individualemotionlike, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=8, set.cap.width=T, num.cols.cap=1, fig.cap='Individual Variation for  Rejection and its positive counterparts, when the head verb is like',warning=FALSE}

subset(individual_emotion_data, Head == 'like') %>% 
  ggplot(aes(as.numeric(as.character(Age)), round(log(Total_ratio), 2), group = Measure, color = Measure)) +
  geom_line(aes(linetype=Measure), alpha = 1) +
  ...
  xlab("child age (months)") + 
  ylab("log(ratio)") + 
#  ggtitle(sum(subset(adam_brown_emotion_data_child,Which=='ratio')$Freq)) +
  ylim(-9.5, -2.5) +
  guides(linetype = guide_legend(nrow = 2))

```

```{r individualemotionwant, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=8, set.cap.width=T, num.cols.cap=1, fig.cap='Individual Variation for  Rejection and its positive counterparts, when the head verb is want',warning=FALSE}

subset(individual_emotion_data, Head == 'want') %>% 
  ggplot(aes(as.numeric(as.character(Age)), round(log(Total_ratio), 2), group = Measure, color = Measure)) +
  geom_line(aes(linetype=Measure), alpha = 1) +
  scale_linetype_manual(values=c("solid", 'solid')) +
  geom_point(aes(color = Measure, shape = Measure), size = 1) +
...
individual_perception_data <- rbind(child_individual_existence_neg, individual_perception_data)
...
individual_perception_data <- rbind(child_individual_possession_have_neg, individual_perception_data)
...
individual_perception_data <- rbind(child_individual_possession_pro_neg, individual_perception_data)
...
individual_perception_data <- rbind(parent_individual_existence_neg, individual_perception_data)
...
individual_perception_data <- rbind(parent_individual_possession_have_neg, individual_perception_data)
...
individual_perception_data <- rbind(parent_individual_possession_pro_neg, individual_perception_data)
...
individual_perception_data <- rbind(child_individual_existence_pos, individual_perception_data)
...
individual_perception_data <- rbind(child_individual_possession_have_pos, individual_perception_data)
...
individual_perception_data <- rbind(child_individual_possession_pro_pos, individual_perception_data)
...
individual_perception_data <- rbind(parent_individual_existence_pos, individual_perception_data)
...
individual_perception_data <- rbind(parent_individual_possession_have_pos, individual_perception_data)
...
individual_perception_data <- rbind(parent_individual_possession_pro_pos, individual_perception_data)

}}


individual_perception_data$Measure <- factor(individual_perception_data$Measure, levels = c('negative construction ratio', 'negative construction moving ratio', 'positive construction ratio', 'positive construction moving ratio'))

individual_perception_data <- subset(individual_perception_data, Measure %in% c('negative construction moving ratio', 'positive construction moving ratio') & Child != '0')

individual_perception_data_child <- subset(individual_perception_data, Role == 'Child')
individual_perception_data_parent <- subset(individual_perception_data, Role == 'Parent')

individual_existence_data <- subset(individual_perception_data, Function == 'Non-existence')
individual_possession_data <- subset(individual_perception_data, Function == 'Possession')
...
```{r individualexistence, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=8, set.cap.width=T, num.cols.cap=1, fig.cap='Individual variation for Non-existence and its positive counterparts', warning=FALSE}
...
individual_motor_data <- rbind(child_individual_prohibition_neg, individual_motor_data)
...
individual_motor_data <- rbind(child_individual_inability_neg, individual_motor_data)
...
individual_motor_data <- rbind(parent_individual_prohibition_neg, individual_motor_data)
...
individual_motor_data <- rbind(parent_individual_inability_neg, individual_motor_data)
...
individual_motor_data <- rbind(child_individual_prohibition_pos, individual_motor_data)
...
individual_motor_data <- rbind(child_individual_inability_pos, individual_motor_data)
...
individual_motor_data <- rbind(parent_individual_prohibition_pos, individual_motor_data)
...
individual_motor_data <- rbind(parent_individual_inability_pos, individual_motor_data)

}}



individual_motor_data$Measure <- factor(individual_motor_data$Measure, levels = c('negative construction ratio', 'negative construction moving ratio', 'positive construction ratio', 'positive construction moving ratio'))

individual_motor_data <- subset(individual_motor_data, Measure %in% c('negative construction moving ratio', 'positive construction moving ratio') & Child != '0')

individual_motor_data_child <- subset(individual_motor_data, Role == 'Child')
individual_motor_data_parent <- subset(individual_motor_data, Role == 'Parent')

individual_prohibition_data <- subset(individual_motor_data, Function == 'Prohibition')
individual_inability_data <- subset(individual_motor_data, Function == 'Inability')
...
individual_ability_data_child <- subset(individual_inability_data, Role =='Child')
individual_ability_data_parent <- subset(individual_inability_data, Role =='Parent')
...
```{r individualprohibition, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=8, set.cap.width=T, num.cols.cap=1, fig.cap='Individual variation for Prohibition and its positive counterparts', warning=FALSE}
...
```{r individualinability, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=8, set.cap.width=T, num.cols.cap=1, fig.cap='Individual variation for Inability and its positive counterparts', warning=FALSE}
...
```{r individuallearning, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=8, set.cap.width=T, num.cols.cap=1, fig.cap='Individual variation for Labeling and its positive counterparts', warning=FALSE}
...
```{r individualepistemicknow, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=8, set.cap.width=T, num.cols.cap=1, fig.cap='Individual variation for Epistemic negation and its positive counterparts, when the head verb is know', warning=FALSE}


subset(individual_epistemic_data, Head == 'know') %>% 
  ggplot(aes(as.numeric(as.character(Age)), round(log(Total_ratio), 2), group = Measure, color = Measure)) +
  geom_line(aes(linetype=Measure), alpha = 1) +
  scale_linetype_manual(values=c('solid', 'solid')) +
  geom_point(aes(color = Measure, shape = Measure), size = 1) +
...
```{r individualepistemicremember, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=8, set.cap.width=T, num.cols.cap=1, fig.cap='Individual variation for Epistemic negation and its positive counterparts, when the head verb is remember', warning=FALSE}


subset(individual_epistemic_data, Head == 'remember') %>% 
  ggplot(aes(as.numeric(as.character(Age)), round(log(Total_ratio), 2), group = Measure, color = Measure)) +
  geom_line(aes(linetype=Measure), alpha = 1) +
  scale_linetype_manual(values=c('solid', 'solid')) +
  geom_point(aes(color = Measure, shape = Measure), size = 1) +
...
```{r individualepistemicthink, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=8, set.cap.width=T, num.cols.cap=1, fig.cap='Individual variation for Epistemic negation and its positive counterparts, when the head verb is think', warning=FALSE}


subset(individual_epistemic_data, Head == 'think') %>% 
  ggplot(aes(as.numeric(as.character(Age)), round(log(Total_ratio), 2), group = Measure, color = Measure)) +
  geom_line(aes(linetype=Measure), alpha = 1) +
  scale_linetype_manual(values=c('solid', 'solid')) +
  geom_point(aes(color = Measure, shape = Measure), size = 1) +
...
```{r individualpossession, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=5, set.cap.width=T, num.cols.cap=1, fig.cap='Individual variation for Possession and its positive counterparts', warning=FALSE}
...
parent_individual_all <- subset(together, Role %in% c('Parent'))
...
parent_individual_neg_together <- aggregate(Freq ~ Age + Function, data = subset(parent_individual_all, Polarity == 'negative'), sum)
parent_individual_neg_together$Role <- rep('Parent', nrow(parent_individual_neg_together))
parent_individual_neg_together$Total_ratio <- rep(0, nrow(parent_individual_neg_together))

for (i in 1:nrow(parent_individual_neg_together)){
  age = as.numeric(as.character(parent_individual_neg_together$Age[i]))
  data = subset(parent_individual_descriptive, Age <= age)
  parent_individual_neg_together$Total_ratio[i] = parent_individual_neg_together$Freq[i] / sum(data$N_utterance)

  }


neg_together_final <- rbind(child_neg_together, parent_individual_neg_together)
...
parent_individual_pos_together <- aggregate(Freq ~ Age + Function, data = subset(parent_individual_all, Polarity == 'positive'), sum)
parent_individual_pos_together$Role <- rep('Parent', nrow(parent_individual_pos_together))
parent_individual_pos_together$Total_ratio <- rep(0, nrow(parent_individual_pos_together))

for (i in 1:nrow(parent_individual_pos_together)){
  age = as.numeric(as.character(parent_individual_pos_together$Age[i]))
  data = subset(parent_individual_descriptive, Age <= age)
  parent_individual_pos_together$Total_ratio[i] = parent_individual_pos_together$Freq[i] / sum(data$N_utterance)

  }


pos_together_final <- rbind(child_pos_together, parent_individual_pos_together)


```


```{r allneg, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=5, set.cap.width=T, num.cols.cap=1, fig.cap='All negative functions', warning=FALSE}
...
```{r allpos, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=5, set.cap.width=T, num.cols.cap=1, fig.cap='Positive counpterparts of all negative functions', warning=FALSE}
...
for (i in 1:length(children)){
  select <- data.frame(subset(emotion, Child == children[i] & Polarity == 'negative' & Role == 'Child'))
    if (min(as.vector(unique(select$Age))) <= 24){
...
for (i in 1:length(children)){
  select <- data.frame(subset(perception, Child == children[i] & Polarity == 'negative' & Role == 'Child'))
    if (min(as.vector(unique(select$Age))) <= 24){
  perception_children = c(children[i], perception_children)
  }
}

perception_children = perception_children[1: length(perception_children) - 1]
...
for (i in 1:length(children)){
  select <- data.frame(subset(motor, Child == children[i] & Polarity == 'negative' & Role == 'Child'))
    if (min(as.vector(unique(select$Age))) <= 24){
  motor_children = c(children[i], motor_children)
  }
}

motor_children = motor_children[1: length(motor_children) - 1]
...
for (i in 1:length(children)){
  select <- data.frame(subset(learning, Child == children[i] & Polarity == 'negative' & Role == 'Child'))
    if (min(as.vector(unique(select$Age))) <= 24){
...
for (i in 1:length(children)){
  select <- data.frame(subset(epistemic, Child == children[i] & Polarity == 'negative' & Role == 'Child'))
    if (min(as.vector(unique(select$Age))) <= 24){
...
select = intersect(emotion_children, perception_children)
select=intersect(select, motor_children)
select=intersect(select, learning_children)
select=intersect(select, epistemic_children)
