...
no logging it; but for visualization, we can log it; change the facets from parent and child to negative and positive
...
exponential approach curve; leave for later

+ what does literature call *no*, discourse marker; 
...
did for rejection and "i don't know"

+ "this is my book" should be possession; modify the script
