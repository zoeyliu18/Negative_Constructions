...
discourse_emotion$Previous_Role[which(discourse_emotion$Previous_Role == "Father")] <- 'Parent'
discourse_emotion$Previous_Role[which(discourse_emotion$Previous_Role == "Mother")] <- 'Parent'
discourse_emotion$Previous_Role[which(discourse_emotion$Previous_Role == "Target_Child")] <- 'Child'
...
discourse_child_emotion_neg <- subset(discourse_emotion_neg, Role %in% c('Child') & Previous_Role %in% c('Parent'))
discourse_parent_emotion_neg <- subset(discourse_emotion_neg, Role %in% c('Parent') & Previous_Role %in% c('Child'))
...
### Combining negative and positive antecedents together by adding up their total ratio
### In initial calculation, their respective total ratios were calculated with the same demoninator
...
```{r emotion, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=6.5, fig.height=4, set.cap.width=T, num.cols.cap=1, fig.cap="Cumulative production ratios for the production of rejection at the sentence level for children between 12 to 72 months of age, and their parents. The y-axes are scaled differently for the panels to accommodate differences in production ratios."}

subset(emotion_data, Which=='cumulative ratio')  %>% 
  ggplot(aes(as.numeric(as.character(Age)), Total_ratio * 1000, group = Production, color = Production)) +
...
#  scale_shape_manual(values = c(3, 16, 3, 16)) +
  ...
  ylab("cumulative production ratio (per thoursand)") + 
...
```{r emotiondiscourse, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=3.2, set.cap.width=T, num.cols.cap=1, fig.cap="Cumulative production ratios for the production of rejection at the discourse level for children between 12 to 72 months of age, and their parents.",warning=FALSE}

subset(discourse_emotion_data_plot, Measure=='cumulative ratio') %>% 
  ggplot(aes(as.numeric(as.character(Age)), Total_ratio * 1000, group = Role, color = Role)) +
...
# perception <- subset(perception, Subj == 'I' | Subj == 'NONE')
discourse_perception$Previous_Role[which(discourse_perception$Previous_Role == "Father")] <- 'Parent'
discourse_perception$Previous_Role[which(discourse_perception$Previous_Role == "Mother")] <- 'Parent'
discourse_perception$Previous_Role[which(discourse_perception$Previous_Role == "Target_Child")] <- 'Child'
...
discourse_child_perception_neg <- subset(discourse_perception_neg, Role %in% c('Child') & Previous_Role %in% c('Parent'))
discourse_parent_perception_neg <- subset(discourse_perception_neg, Role %in% c('Parent') & Previous_Role %in% c('Child'))
...
```{r existence, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=6.5, fig.height=3.8, set.cap.width=T, num.cols.cap=1, fig.cap="Cumulative production ratios for the production of non-existence at the sentence level for children between 12 to 72 months of age, and their parents. The y-axes are scaled differently for the panels to accommodate differences in production ratios."}
...
```{r existencediscourse, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=3.5, set.cap.width=T, num.cols.cap=1, fig.cap="Cumulative production ratios for the production of non-existence at the discourse level for children between 12 to 72 months of age, and their parents.",warning=FALSE}
...
discourse_motor$Previous_Role[which(discourse_motor$Previous_Role == "Father")] <- 'Parent'
discourse_motor$Previous_Role[which(discourse_motor$Previous_Role == "Mother")] <- 'Parent'
discourse_motor$Previous_Role[which(discourse_motor$Previous_Role == "Target_Child")] <- 'Child'
...
discourse_child_motor_neg <- subset(discourse_motor_neg, Role %in% c('Child') & Previous_Role %in% c('Parent'))
discourse_parent_motor_neg <- subset(discourse_motor_neg, Role %in% c('Parent') & Previous_Role %in% c('Child'))
...
discourse_motor_data <- rbind(discourse_child_prohibition_pos,  discourse_parent_prohibition_pos, discourse_child_inability_neg, discourse_child_inability_pos, discourse_parent_inability_neg, discourse_parent_inability_pos)
...
```{r prohibition, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=6.5, fig.height=3.8, set.cap.width=T, num.cols.cap=1, fig.cap='Cumulative production ratios for the production of prohibition at the sentence level for children between 12 to 72 months of age, and their parents. The y-axes are scaled differently for the panels to accommodate differences in production ratios.'}
...
```{r prohibitiondiscourse, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=3.5, set.cap.width=T, num.cols.cap=1, fig.cap="Cumulative production ratios for the production of prohibition at the discourse level for children between 12 to 72 months of age, and their parents.",warning=FALSE}
...
```{r inability, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=6.5, fig.height=3.8, set.cap.width=T, num.cols.cap=1, fig.cap="Cumulative production ratios for the production of inability at the sentence level for children between 12 to 72 months of age, and their parents. The y-axes are scaled differently for the panels to accommodate differences in production ratios."}
...
```{r inabilitydiscourse, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=3.2, set.cap.width=T, num.cols.cap=1, fig.cap="Cumulative production ratios for the production of inability at the discourse level for children between 12 to 72 months of age, and their parents.",warning=FALSE}
...
discourse_learning$Previous_Role[which(discourse_learning$Previous_Role == "Father")] <- 'Parent'
discourse_learning$Previous_Role[which(discourse_learning$Previous_Role == "Mother")] <- 'Parent'
discourse_learning$Previous_Role[which(discourse_learning$Previous_Role == "Target_Child")] <- 'Child'
...
discourse_child_learning_neg <- subset(discourse_learning_neg, Role %in% c('Child') & Previous_Role %in% c('Parent'))
discourse_parent_learning_neg <- subset(discourse_learning_neg, Role %in% c('Parent') & Role %in% c('Child'))
...
discourse_learning_data <- rbind(discourse_child_learning_neg, discourse_child_learning_pos,  discourse_parent_learning_pos)
...
```{r learning, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=6.5, fig.height=3.8, set.cap.width=T, num.cols.cap=1, fig.cap="Cumulative production ratios for the production of (negative) labeling at the sentence level for children between 12 to 72 months of age, and their parents. The y-axes are scaled differently for the panels to accommodate differences in production ratios."}
...
```{r learningdiscourse, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=3.2, set.cap.width=T, num.cols.cap=1, fig.cap="Cumulative production ratios for the production of (negative) labeling at the discourse level for children between 12 to 72 months of age, and their parents.",warning=FALSE}
...
discourse_epistemic$Previous_Role[which(discourse_epistemic$Previous_Role == "Father")] <- 'Parent'
discourse_epistemic$Previous_Role[which(discourse_epistemic$Previous_Role == "Mother")] <- 'Parent'
discourse_epistemic$Previous_Role[which(discourse_epistemic$Previous_Role == "Target_Child")] <- 'Child'
...
discourse_child_epistemic_neg <- subset(discourse_epistemic_neg, Role %in% c('Child') & Previous_Role %in% c('Parent'))
discourse_parent_epistemic_neg <- subset(discourse_epistemic_neg, Role %in% c('Parent') & Previous_Role %in% c('Child'))
...
```{r epistemic, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=6.5, fig.height=8, set.cap.width=T, num.cols.cap=1, fig.cap="Cumulative production ratios for the production of epistemic negation at the sentence level for children between 12 to 72 months of age, and their parents. The y-axes are scaled differently for the panels to accommodate differences in production ratios."}
...
: (#tab:disepistem) Examples of discourse-level epistemic negation in children's and parents' speech.

```{r epistemicdiscourse, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=3.2, set.cap.width=T, num.cols.cap=1, fig.cap="Cumulative production ratios for the production of epistemic negation at the discourse level for children between 12 to 72 months of age, and their parents.",warning=FALSE}
...
```{r possession, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=6.5, fig.height=5, set.cap.width=T, num.cols.cap=1, fig.cap="Cumulative production ratios for the production of possession at the sentence level for children between 12 to 72 months of age, and their parents. The y-axes are scaled differently for the panels to accommodate differences in production ratios."}
...
```{r possessiondiscourse, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=3.2, set.cap.width=T, num.cols.cap=1, fig.cap="Cumulative production ratios for the production of possession at the discourse level for children between 12 to 72 months of age, and their parents.",warning=FALSE}
...
```{r allneg, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=5, set.cap.width=T, num.cols.cap=1, fig.cap="Cumulative production ratios for all negative responses at the sentence level.", warning=FALSE}

neg_together_final %>% 
  ggplot(aes(as.numeric(as.character(Age)), Total_ratio * 1000, group = Function, color = Function)) +
...
```{r allnegagerestricted, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=5, set.cap.width=T, num.cols.cap=1, fig.cap="Cumulative production ratios for all negative constructions at the sentence level when children are between 12-24 months of age.", warning=FALSE}

subset(neg_together_final, Age >= 12 & Age <= 24) %>% 
  ggplot(aes(as.numeric(as.character(Age)), Total_ratio * 1000, group = Function, color = Function)) +
  geom_line(aes(linetype=Function), alpha = 1) +
  scale_color_brewer(palette = "Dark2") +
  geom_point(aes(color = Function, shape = Function), size = 1.5) +
...
```{r allpos, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=5, set.cap.width=T, num.cols.cap=1, fig.cap="Cumulative production ratios for the positive counterparts to all negative constructions at the sentence level.", warning=FALSE}
...
```{r allposagerestricted, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=5, set.cap.width=T, num.cols.cap=1, fig.cap="Cumulative productive ratios for the positive counpterparts to all negative constructions at the sentence level when children are between 12-24 months of age.", warning=FALSE}

subset(pos_together_final, Age >= 12 & Age <= 24) %>% 
  ggplot(aes(as.numeric(as.character(Age)), Total_ratio * 1000, group = Function, color = Function)) +
  geom_line(aes(linetype=Function), alpha = 1) +
  scale_color_brewer(palette = "Dark2") +
  geom_point(aes(color = Function, shape = Function), size = 1.5) +
...
### Combining negative and positive together
...
```{r alldiscourse, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=5, set.cap.width=T, num.cols.cap=1, fig.cap="Cumulative production ratios for all negative constructions at the discourse level.", warning=FALSE}
...
predictions %>%
  ...
  ggplot(aes(Age.x, Age.predicted, color=valence, linetype=valence)) +
...
aoa_estimates %>%
  ...
  geom_point(position=position_dodge(0.4), aes(shape=valence)) +
...
predictions %>%
  ...
  ggplot(aes(Age.x, Age.predicted, color=level, linetype=level)) +
...
names(aoa_all) <- c('functions', 'mean', 'lower', 'upper', 'level')

```

```{r sentenceDiscourseInflectionPlot, fig.env="figure", fig.pos = "H", fig.align = "center", fig.width=7, fig.height=4, fig.cap="Estimates with 95 percent credible intervals for inflection points of the Gompertz growth curves for discourse-level (red) and sentence-level (green) negative constructions. The x-axis is age in months, and the y-axis represents seven negative constructions."}
aoa_all %>%
  ggplot(aes(mean, functions, color=level)) +
  geom_point(position=position_dodge(0.4), aes(shape=level)) +
  geom_linerange(aes(xmin=lower, xmax=upper), position=position_dodge(0.4)) +
  scale_x_continuous(breaks = seq(12, 72, by = 2)) +
  theme_bw() +
  xlab("child age (months)") + 
